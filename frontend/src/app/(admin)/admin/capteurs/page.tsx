      ...
      const demoData: Capteur[] = [
        {
          ...
          agriculteur_nom: 'Kouamé Yao',
          derniere_mesure: new Date().toISOString(),
          batterie: 85,
          signal: 92,
        ...
        },
        {
          ...
          type: 'temperature',
          status: 'actif',
          parcelle_nom: 'Parcelle Café Est',
          agriculteur_nom: 'Koné Mamadou',
          derniere_mesure: new Date().toISOString(),
          batterie: 72,
          signal: 88,
        ...
        },
        {
          ...
          type: 'ph',
          status: 'maintenance',
          parcelle_nom: 'Parcelle Riz Sud',
          agriculteur_nom: 'Bamba Seydou',
          derniere_mesure: new Date(Date.now() - 86400000).toISOString(),
          batterie: 45,
          signal: 65,
        ...
        },
        {
          ...
          type: 'npk',
          status: 'defaillant',
          parcelle_nom: 'Parcelle Maïs Ouest',
          agriculteur_nom: 'Traoré Ibrahim',
          derniere_mesure: new Date(Date.now() - 172800000).toISOString(),
          batterie: 12,
          signal: 23,
