...
export default function AdminExportPage() {
  ...
  const [exportHistory, setExportHistory] = useState<ExportHistory[]>([
    { id: '1', type: 'users', date: '2024-12-05 10:30', status: 'completed', size: '245 KB' },
    { id: '2', type: 'mesures', date: '2024-12-04 15:45', status: 'completed', size: '1.2 MB' },
    { id: '3', type: 'alertes', date: '2024-12-03 09:15', status: 'failed' },
  ])
  ...
  const handleExport = async () => {
    ...
    setExporting(true)
    try {
      // Simuler un export (en production, appeler l'API)
      await new Promise((resolve) => setTimeout(resolve, 2000))

      // Créer un fichier Excel factice pour la démo
