...
const MOCK_USERS: User[] = [
    {
        id: '1',
        name: 'Kouassi Jean',
        email: 'jean.kouassi@agri.ci',
        role: 'PRODUCTEUR',
        status: 'ACTIF',
        cooperative: 'Coopérative Yamoussoukro',
        lastLogin: '2024-12-09 10:30'
    },
    {
        id: '2',
    ...
    },
    {
        id: '3',
        name: 'Koné Moussa',
        email: 'moussa.k@agri.ci',
        role: 'CONSEILLER',
        status: 'ACTIF',
        cooperative: 'Zone Nord',
        lastLogin: '2024-12-08 15:45'
    },
    {
        id: '4',
        name: 'Traoré Awa',
        ...
        role: 'PRODUCTEUR',
        status: 'INACTIF',
        cooperative: 'Coopérative Bouaké',
