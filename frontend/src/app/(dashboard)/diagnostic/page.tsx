...
const diagnosticHistory: DiagnosticResult[] = [
  {
    ...
    severite: 'moyenne',
    recommandations: [
      'Retirer les cabosses infectées',
    ...
    traitements: [
      {
        ...
        type: 'biologique',
        efficacite: 85,
        description: 'Fongicide à base de cuivre, respectueux de l\'environnement',
      },
      {
        nom: 'Mancozèbe',
        type: 'chimique',
        efficacite: 92,
        description: 'Fongicide de contact à large spectre',
      },
    ],
  },
  {
    id: '2',
    image: '/placeholder-leaf2.jpg',
    date: '2024-01-10T14:20:00',
    culture: 'Café',
    maladie: 'Rouille orangée',
    confiance: 88,
    severite: 'elevee',
    recommandations: [
      'Élaguer les branches affectées',
      'Augmenter l\'espacement entre les plants',
      'Traiter avec un fongicide systémique',
    ],
    traitements: [
      {
        nom: 'Triazole',
        type: 'chimique',
        efficacite: 90,
        description: 'Fongicide systémique efficace contre la rouille',
      },
    ],
  },
]
...
export default function DiagnosticPage() {
  ...
  const [history, setHistory] = useState<DiagnosticResult[]>(diagnosticHistory)
    ...
    try {
      ...
      setTimeout(() => {
        const mockResult: DiagnosticResult = {
          ...
          culture: 'Cacao',
          maladie: 'Pourriture brune des cabosses',
          confiance: 91,
          severite: 'moyenne',
          recommandations: [
            'Éliminer immédiatement les fruits infectés',
            'Améliorer le drainage du sol',
            'Appliquer un traitement fongicide préventif',
            'Augmenter l\'ombrage pour réduire l\'humidité',
          ],
          traitements: [
            {
              nom: 'Bouillie bordelaise',
              type: 'biologique',
              efficacite: 85,
              description: 'Traitement traditionnel à base de cuivre, idéal pour l\'agriculture biologique',
            },
            {
              nom: 'Trichoderma',
              type: 'biologique',
              efficacite: 78,
              description: 'Agent de biocontrôle naturel qui protège les racines',
            },
            {
              nom: 'Métalaxyl',
              type: 'chimique',
              efficacite: 94,
              description: 'Fongicide systémique très efficace, à utiliser avec précaution',
            },
          ],
        }
