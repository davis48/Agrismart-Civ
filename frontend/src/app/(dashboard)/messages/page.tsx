      ...
      setConversations([
        {
          ...
          participant_nom: 'Jean Kouassi',
          dernier_message: 'D\'accord, je vous envoie les photos',
        ...
        },
        {
          ...
          participant_nom: 'Marie Bamba',
          dernier_message: 'Merci pour les conseils!',
          dernier_message_at: new Date(Date.now() - 3600000).toISOString(),
          non_lus: 0,
          is_online: false,
        },
        {
          ...
          participant_nom: 'Support AgriTech',
          dernier_message: 'Votre demande a été traitée',
          dernier_message_at: new Date(Date.now() - 86400000).toISOString(),
          non_lus: 1,
          is_online: true,
        },
      ])
    ...
    try {
      ...
      setMessages([
        ...
        },
        {
          ...
          conversation_id: conversationId,
          expediteur_id: 'other',
          contenu: 'Je voulais vous demander des conseils sur la culture du cacao.',
          type: 'texte',
          lu: true,
        ...
        },
        {
          ...
          conversation_id: conversationId,
          expediteur_id: user?.id || 'me',
          contenu: 'Bien sûr, je serai ravi de vous aider!',
          type: 'texte',
          lu: true,
